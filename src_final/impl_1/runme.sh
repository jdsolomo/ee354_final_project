...
HD_PWD='C:/Users/joshu/OneDrive/Desktop/Academic/EE 354/Labs/Final Project/ee354_final_project/src_final/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log wwm_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source wwm_top.tcl -notrace
