...
HD_PWD='C:/Users/joshu/OneDrive/Desktop/Academic/EE 354/Labs/Final Project/ee354_final_project/src_final/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log wwm_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source wwm_top.tcl
